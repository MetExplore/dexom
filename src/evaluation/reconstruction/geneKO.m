function [grRatio, grRateKO, grRateWT, hasEffect, delRxns, fluxSolution] = geneKO(model, method, geneList, verbFlag, uniqueGene)
% MODIFIED METHOD FROM COBRA TOOLBOX
%
% Performs single gene deletion analysis using FBA, MOMA or linearMOMA
%
% USAGE:
%
%    [grRatio, grRateKO, grRateWT, hasEffect, delRxns, fluxSolution] = geneKO(model, method, geneList, verbFlag)
%
% INPUT:
